...
formats = {'count':'file'}# if a program has single liner input and output, we put all test cases in single file. Otherwise, we have a file for test and associated file with results
...
if __name__ == '__main__':
    ...
    if tarmode==False:
        if not os.path.isdir(basepath):
            print "pa2 is not presnt in this directory."
            sys.exit(1)
        else:
